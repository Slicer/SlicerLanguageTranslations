...
Repository to store source and localized language translation files for [3D Slicer](https://www.slicer.org) and its extensions. It is used by the [LanguagePacks extension](https://github.com/SoniaPujolLab/SlicerLanguagePacks). **Add/edit translations for any language on [Weblate](https://hosted.weblate.org/projects/3d-slicer/).**
