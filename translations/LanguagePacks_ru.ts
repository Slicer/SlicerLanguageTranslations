...
<context>
    ...
    <message>
        ...
        <translation>Загружайте, компилируйте и устанавливайте последние версии переводов</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Weblate API ключ:</translation>
    </message>
    <message>
        ...
        <translation>Оставьте пустым для использования значения по умолчанию. Необязательный ключ API для Weblate. Укажите его, если вам нужен доступ к частным проектам или требуется обойти ограничения по частоте запросов.</translation>
    </message>
    <message>
        ...
        <translation>Оставьте пустым для использования значения по умолчанию (инструменты Qt lrelease, поставляемые с установщиком Slicer или доступные в системных путях). Укажите путь, чтобы использовать пользовательский исполняемый файл Qt lrelease.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ввод переводов</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Обновите список языков Weblate, запросив сервер Weblate.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Выберите язык (языки), который (которые) будет загружен и установлен.</translation>
    </message>
    <message>
        ...
        <translation>Папка, содержащая файлы перевода (.ts).</translation>
    </message>
    <message>
        ...
        <translation>&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p&gt;Если этот параметр установлен, то будет использоваться только последний .ts-файл в папке. Включите этот параметр, чтобы игнорировать ранее загруженные .ts-файлы, сохраненные в той же папке.&lt;/p&gt;&lt;/body&gt;&lt;/html&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Изменение вступает в силу только после перезапуска приложения.</translation>
    </message>
    <message>
        ...
        <translation>Перезапустите приложение, чтобы увидеть обновленные переводы в графическом интерфейсе пользователя.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Путь к инструменту Qt &apos;lrelease&apos;:</translation>
    </message>
    <message>
        ...
        <translation>Список папок, в которых приложение ищет файлы переводов. Эта информация предоставлена только для справки, пути не могут быть изменены.</translation>
    </message>
    <message>
        <location filename="LanguageTools/Resources/UI/LanguageTools.ui" line="62"/>
        <source>Slicer version:</source>
        <translation>Версия Slicer:</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Репозиторий Github, в котором хранятся переведенные строки.</translation>
    </message>
    <message>
...
See more information in the &lt;a href=&quot;https://github.com/SoniaPujolLab/SlicerLanguagePacks&quot;&gt;extension&apos;s documentation&lt;/a&gt;.
        ...
        <translation>
Этот модуль позволяет собирать файлы переводов и устанавливать их локально. Он полезен для создания и тестирования переводов.
Дополнительную информацию смотрите в &lt;a href=&quot;https://github.com/SoniaPujolLab/SlicerLanguagePacks&quot;&gt;документации расширения&lt;/a&gt;.
</translation>
    </message>
    <message>
...
See more information in the &lt;a href=&quot;https://github.com/Slicer/SlicerLanguagePacks&quot;&gt;extension&apos;s documentation&lt;/a&gt;.
        ...
        <translation>
Разработка этого модуля была частично поддержана &lt;a href=&quot;https://chanzuckerberg.com/eoss/proposals/3d-slicer-in-my-language-internationalization-and-usability-improvements/&quot;&gt;грантом CZI EOSS&lt;/a&gt;.
</translation>
    </message>
    <message>
        <location filename="LanguageTools/LanguageTools.py" line="178"/>
        <source>Failed to extract any text from widget</source>
        <translation>Не удалось извлечь какой-либо текст из виджета</translation>
    </message>
    <message>
...
{links}</translation>
    ...
    <message>
        ...
        <translation>Пропущено. Загруженный файл недействителен.</translation>
    </message>
    <message>
