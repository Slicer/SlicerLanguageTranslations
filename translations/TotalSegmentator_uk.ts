...
<context>
    ...
    <message>
        ...
        <translation>Введіть дані КТ черевної порожнини, грудної клітки або всього тіла.</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/Resources/UI/TotalSegmentator.ui" line="51"/>
        <source>Segmentation task:</source>
        <translation>Завдання сегментації:</translation>
    </message>
    <message>
        ...
        <translation>Виберіть «всього» для сегментації всіх структур або будь-яке з більш спеціалізованих завдань сегментації (які сегментують лише кілька конкретних структур у певному регіоні).</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Увімкніть опцію «Швидко», щоб отримати менш точні результати швидше.</translation>
    </message>
    <message>
        ...
        <translation>Швидкий режим недоступний для цього завдання</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Якщо ввімкнено (за замовчуванням), то назви сегментів отримуються зі стандартних термінологічних файлів Slicer. Якщо вимкнено, то як назви сегментів використовуються ідентифікатори TotalSegmentator.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Пакет TotalSegmentator на Python:</translation>
    </message>
    <message>
        ...
        <translation>Примусово оновити пакет TotalSegmentator Python до версії, необхідної для цього модуля.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ліцензія TotalSegmentator: </translation>
    </message>
    <message>
        ...
        <translation>Отримати метадані для встановленого пакета TotalSegmentator</translation>
    </message>
    <message>
        ...
        <translation>Отримати інформацію про пакет TotalSegmentator</translation>
    </message>
    <message>
        ...
        <translation>Встановіть або оновіть ліцензійний ключ TotalSegmentator, щоб дозволити запуск завдань, що потребують ліцензії. Реєстрацію потрібно виконати лише один раз, інформація про ліцензію постійно зберігається в конфігурації TotalSegmentation.</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/Resources/UI/TotalSegmentator.ui" line="263"/>
        <source>Set license key</source>
        <translation>Встановити ліцензійний ключ</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="27"/>
        <source>Total Segmentator</source>
        <translation>Загальний сегментатор</translation>
    </message>
    <message>
...
See more information in the &lt;a href=&quot;https://github.com/lassoan/SlicerTotalSegmentator&quot;&gt;extension documentation&lt;/a&gt;.
        ...
        <translation>
Розширення 3D Slicer для повністю автоматичної сегментації КТ всього тіла з використанням моделі штучного інтелекту &quot;TotalSegmentator&quot;.
Докладніше див. у &lt;a href=&quot;https://github.com/lassoan/SlicerTotalSegmentator&quot;&gt;документації до розширення&lt;/a&gt;.
</translation>
    </message>
    <message>
...
https://arxiv.org/abs/2208.05868
        ...
        <translation>
Цей файл був спочатку розроблений Андрасом Лассо (PerkLab, Університет Королеви).
Модуль використовує &lt;a href=&quot;https://github.com/wasserth/TotalSegmentator&quot;&gt;TotalSegmentator&lt;/a&gt;.
Якщо ви використовуєте функцію TotalSegmentator nn-Unet з цього програмного забезпечення у своєму дослідженні, будь ласка, цитуйте:
Wasserthal J., Meyer M., , Hanns-Christian Breit H.C., Cyriac J., Shan Y., Segeroth, M.:
TotalSegmentator: надійна сегментація 104 анатомічних структур на КТ-зображеннях.
https://arxiv.org/abs/2208.05868
</translation>
    </message>
    <message>
        ...
        <translation>{task_title} [потрібна ліцензія]</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Виберіть гучність вхідного сигналу</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="226"/>
        <source>{volume_name} segmentation</source>
        <translation>{volume_name} сегментація</translation>
    </message>
    <message>
        ...
        <translation>Введений вами об&apos;єм є частиною послідовності. Ви хочете сегментувати всі кадри цієї послідовності?</translation>
    </message>
    <message>
...
{exception}
        ...
        <translation>Не вдалося встановити залежності Python:
{exception}
</translation>
    </message>
    <message>
        ...
        <translation>Потрібно перезапустити програму.</translation>
    </message>
    <message>
...
Press OK to restart.</source>
        <translation>Для завершення встановлення необхідних пакетів Python потрібна програма.
Натисніть OK для перезапуску.</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="290"/>
        <source>Confirm application restart</source>
        <translation>Підтвердьте перезапуск програми</translation>
    </message>
    <message>
...
{exception}</source>
        <translation>Не вдалося встановити необхідні пакети.
...
{exception}</translation>
    ...
    <message>
        ...
        <translation>Не вдалося отримати інформацію про версію пакета TotalSegmentator</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="320"/>
        <source>Failed to upgrade TotalSegmentator</source>
        <translation>Не вдалося оновити TotalSegmentator</translation>
    </message>
    <message>
        ...
        <translation>Це оновлення TotalSegmentator вимагає перезапуску 3D-зрізу.</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="323"/>
    ...
    <message>
        ...
        <translation>Перезапуск скасовано.</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="330"/>
        <source>Set TotalSegmentator license key</source>
        <translation>Встановити ліцензійний ключ TotalSegmentator</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="330"/>
    ...
    <message>
        ...
        <translation>Не вдалося встановити ліцензію TotalSegmentator.</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="335"/>
        <source>License is not specified.</source>
        <translation>Ліцензія не вказана.</translation>
    </message>
    <message>
        ...
        <translation>Ліцензійний ключ встановлено. Тепер ви можете використовувати завдання TotalSegmentator, які потребують ліцензії.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Цей модуль вимагає встановлення додаткових пакетів Python. Встановлення потребує мережевого підключення та може тривати кілька хвилин. Натисніть кнопку «ОК», щоб продовжити.</translation>
    </message>
    <message>
        <location filename="TotalSegmentator/TotalSegmentator.py" line="802"/>
        <source>Confirm Python package installation</source>
        <translation>Підтвердьте встановлення пакета Python</translation>
    </message>
    <message>
        ...
        <translation>Пакети Python, які будуть встановлені: {package_list}</translation>
    </message>
    <message>
        ...
        <translation>Потрібен пакет PyTorch Python. Встановлення... (це може тривати кілька хвилин)</translation>
    </message>
    <message>
