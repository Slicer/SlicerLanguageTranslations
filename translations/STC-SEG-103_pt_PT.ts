...
AI-powered segmentation tools can reduce the segmentation time and provide more reproducible results.</source>
        ...
        <translation>Na última década, a segmentação de imagens tem sido alimentada pelo desenvolvimento de algoritmos de aprendizagem profunda (por exemplo, nnUnet pelo Centro Alemão de Pesquisa de Cancro (DKFZ)/Helmholtz Research).
